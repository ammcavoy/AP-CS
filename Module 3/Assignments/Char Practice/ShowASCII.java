...
public class ShowASCII
{
    ...
    {   
        ...
        System.out.println("The ASCII code for " + 'A' + " is " + (double)'A');
        ...
        System.out.println("when one enters " + '8' + " + " + '2' + " and gets " + ((int)'8' + (int)'2'));
        System.out.println("it is because " + '8' + " is " + (int)'8' +" and " + '2' + " is " + (int)'2');
        System.out.println();
        ...
        System.out.print((char)100);
        System.out.print((char)97);
        System.out.print((char)121);       //83 101 110 100 32 121 111 117 114 32 116 101 97 99 104 101 114 32        //97 110 32 101 109 97 105 108 32 116 111 100 97 121
